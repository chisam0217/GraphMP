...
if __name__ == "__main__":
    ...
    with open('data/own_pkl/kuka14_prm_{}_{}.pkl'.format(n_sample, n_neighbor), 'wb') as f:
        pickle.dump([data[i] for i in index_3000], f, pickle.DEFAULT_PROTOCOL)

    with open('data/own_pkl/problems_kuka14_{}_{}.pkl'.format(n_sample, n_neighbor), 'wb') as f:
