...
if __name__ == "__main__":
    ...
    # with open('data/own_pkl/ur5_prm_{}_{}.pkl'.format(n_sample, n_neighbor), 'wb') as f:
    with open('data/own_pkl/ur5_prm_random_random.pkl', 'wb') as f:
        pickle.dump(data, f, pickle.DEFAULT_PROTOCOL)

    # Change before Jul 23
    ...
    # with open('data/own_pkl/problems_ur5_{}_{}.pkl'.format(n_sample, n_neighbor), 'wb') as f:
